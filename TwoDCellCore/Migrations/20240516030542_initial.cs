        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    xpRequire = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_gun_upgrade_config", x => x.mutationLv);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_mutation_upgrade_config", x => x.mutationLv);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    userID = table.Column<string>(type: "nchar(30)", fixedLength: true, maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MutationID = table.Column<string>(type: "nchar(10)", fixedLength: true, maxLength: 10, nullable: false),
                    mutationLv = table.Column<int>(type: "int", nullable: false),
                    mutationiXp = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BodyDamage = table.Column<int>(type: "int", fixedLength: true, nullable: true)
                },
                constraints: table =>
                {
